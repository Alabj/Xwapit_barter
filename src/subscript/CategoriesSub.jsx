  ...
  return (
    <div>
       <div className="p-[1rem]">
            <p className="py-[1rem] text-xl font-semibold ml-[4rem]">Categories</p>
            
            <div className="flex justify-evenly text-center">
                    <div className="">
                        <img src={PinkCircle} alt="" className="w-[3rem]" />
                        <p className="text-sm">All</p>
                    </div>

                    <div className="">
                        <img src={Books} alt="" className="w-[3rem]" />
                        <p className="text-sm">Books</p>
                    </div>

                    <div className="">
                        <img src={Computer} alt="" className="w-[3rem]" />
                        <p className="text-sm">Gadgets</p>
                    </div>

                    <div className="">
                        <img src={Foods} alt="" className="w-[3rem]" />
                        <p className="text-sm">Foods</p>
                    </div>

                    <div className="">
                        <img src={HandEx} alt="" className="w-[3rem]" />
                        <p className="text-sm">Accesories</p>
                    </div>

                    <div className="">
                        <img src={Shirt} alt="" className="w-[3rem]" />
                        <p className="text-sm">Clothes</p>
                    </div>

                    <div className="">
                        <img src={shoes} alt="" className="w-[3rem]" />
                        <p className="text-sm">Shoes</p>
                    </div>

                    <div className="">
                        <img src={Utensils} alt="" className="w-[3rem]" />
